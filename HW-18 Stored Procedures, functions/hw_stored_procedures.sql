...
/*
Во всех процедурах/функциях представлены выборки, поэтому достаточно дефолтного read committed, 
он поможет справиться с аномалией Dirty Read.
Но чтобы не было блокировок можно воспользоваться инструкцией READ_COMMITTED_SNAPSHOT ON.
*/